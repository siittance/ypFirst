...
urlpatterns = [
    ...
    path('registr/', views.registration_user, name='registration_user'),
    ...
    path('product_categories/<int:pk>/update/', views.ProductCategoryUpdateView.as_view(), name='product_category_update'),
    path('product_categories/<int:pk>/delete/', views.ProductCategoryDeleteView.as_view(), name='product_category_delete'),
